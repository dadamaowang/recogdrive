# -*- encoding: utf-8 -*-
'''
@File    :   negdrive_actionhead.py
@Time    :   2026/03/18 12:22:58
@Author  :   Nuoqian Xiao
@Version :   0.0.1
@Contact :   feimaoxiaotianshi@outlook.com
@License :   (C)Copyright 2024-2025, Nuoqian Xiao
@Status  :   None
@Desc    :   跟 recogdrive 的 diffusion planner 一样
'''
...
@dataclass
class NegDriveDiffusionPlannerConfig(PretrainedConfig):
...
class NegDriveDiffusionPlanner(nn.Module):
    config_class = NegDriveDiffusionPlannerConfig

    def __init__(self, config: NegDriveDiffusionPlannerConfig):
        super().__init__()
        self.config = config
